...
public class TopDownShooting : MonoBehaviour
{
    ...
    private void OnShoot(AttackSO attackSO)
    {
        ...
        float projectilesAngleSpace = RangedAttackSO.multipleProjectilesAngel;          //몆도만큼 띄워서하는지 각도
        int numberOfProjectilesPerShot = RangedAttackSO.numberofProjectilesPerShot;     //한번에 몇발 나가는지
    ...
    private void CreateProjectile(RangedAttackSO RangedAttackSO, float angle)
    {
        ...
        // 발사체 기본 세팅
        obj.transform.position = projectileSpawnPosition.position;          //기본위치 저장
